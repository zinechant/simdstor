...
int main() {
  ...
  test<uint8_t, uint32_t>(1 << 8, 16, "dict1.save");
  test<uint16_t, uint32_t>(1 << 16, 21, "dict2.save");
  test<uint32_t, uint32_t>(1 << 20, 24, "dict3.save");

  test<uint8_t, uint16_t>(1 << 5, 8, "dict4.save");
  test<uint8_t, uint32_t>(1 << 8, 16, "dict5.save");
  test<uint16_t, uint32_t>(1 << 16, 21, "dict6.save");
  test<uint32_t, uint32_t>(1 << 20, 24, "dict7.save");

  test<uint8_t, uint16_t>(1 << 5, 8, "dict8.save");
  test<uint8_t, uint32_t>(1 << 8, 16, "dict9.save");
  test<uint16_t, uint32_t>(1 << 16, 21, "dict10.save");
  test<uint32_t, uint32_t>(1 << 20, 24, "dict11.save");

  test<uint8_t, uint16_t>(1 << 5, 8, "dict12.save");
  test<uint8_t, uint32_t>(1 << 8, 16, "dict13.save");
  test<uint16_t, uint32_t>(1 << 16, 21, "dict14.save");
  test<uint32_t, uint32_t>(1 << 20, 24, "dict15.save");
